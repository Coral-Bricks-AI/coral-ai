...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Infer = channel.unary_unary(
                '/gpu_inference.InferenceService/Infer',
        ...
        self.HealthCheck = channel.unary_unary(
                '/gpu_inference.InferenceService/HealthCheck',
...
def add_InferenceServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'gpu_inference.InferenceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('gpu_inference.InferenceService', rpc_method_handlers)
